...
public class LessThanComparison extends NumberComparison {
    public LessThanComparison(ConfigurationSection parent, String key, @Nullable WbsSettings settings, @Nullable String directory) {
