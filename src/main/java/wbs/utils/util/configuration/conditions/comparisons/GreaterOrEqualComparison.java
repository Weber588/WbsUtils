...
public class GreaterOrEqualComparison extends NumberComparison {
    public GreaterOrEqualComparison(ConfigurationSection parent, String key, @Nullable WbsSettings settings, @Nullable String directory) {
